...
import com.sansan.example.bizcardocr.domain.entity.googleapis.vision.AnnotateImageResponse
...
class BizCardParseUseCaseTest {
    ...
    fun parseOcrResultCase1() {
        ...
        val result = BizCardParseUseCase.parseOcrResult(response)
